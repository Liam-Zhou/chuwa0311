...
public class StreamApiCreationTest {
    ...
    public static void testCollection() {
        ...
        //）stream是按顺序处理集合中的元素，而parallelStream则可以利用多线程同时处理集合中的元素，以提高处理速度。
    ...
    public static void testArrays() {
        ...
        Employee e1 = new Employee(1001, "Tom", 20, 2900);
        Employee e2 = new Employee(1002, "Jerry", 18, 5000);
        Employee[] arr_e = new Employee[]{e1, e2};
        Stream<Employee> stream_e = Arrays.stream(arr_e);
        System.out.println("Stream object:     " + stream_e);
    }
